...
describe('Code', () => {
  ...
  it('Should copy text to cliboard when clicked', () => {
    const dom = createDom(
      <body>
        <pre>
          <code>{code}</code>
    ...
    expect(dom.querySelector('[title="Copy to clipboard"]')).toBeNull();
    ...
    fireEvent.click(dom.querySelector('[title="Copy to clipboard"]')!);
